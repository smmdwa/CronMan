...
//                System.out.println("in:"+fristin.getFrom());
...
//                System.out.println("out:"+fristout.getTo());
    ...
    public int getIndegree(String str) {
        int i = 0;
        int pos=getPosition(Long.valueOf(str));
        AdjacencyType temp = this.verArr[pos].firstIn;
        if (temp == null)
            return i;
        while (true) {
            if (temp != null) {
    ...
    public int getOutdegree(String str) {
        int i = 0;
        int pos=getPosition(Long.valueOf(str));
        AdjacencyType temp = this.verArr[pos].firstOut;
        if (temp == null)
            return i;
        while (true) {
            if (temp != null) {
